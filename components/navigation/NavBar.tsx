  ...
  return (
    <div className={`bg-white ${className} z-50`}>
      <div className='flex w-full items-center justify-between py-6 lg:justify-start lg:space-x-2'>
        ...
        <div className='-my-2 -mr-2 flex flex-row items-center justify-center xl:hidden' data-testid='Navbar-search'>
          <SearchButton
        ...
        <nav
          className='hidden w-full space-x-4 xl:flex xl:items-center xl:justify-end xl:space-x-8'
